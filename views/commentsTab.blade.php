...
<div class="table-responsive">
    <table class="table table-condensed table-hover sectionTrans">
        ...
        <tr>
            ...
            <th style="text-align:center;">@lang('sArticles::global.article')</th>
            <th style="text-align:center;">@lang('sArticles::global.author')</th>
        ...
        @foreach($comments as $comment)
            <tr id="comment{{ $comment->comid }}">
                <td>
                    <span id="comment{{ $comment->comid }}tinytext"><b>{!! Str::limit($comment->comment, 1050, "...") !!}</b></span>
                </td>
                <td style="text-align:center;">
                    <a href="{{$url}}&get=article_comments&i={{$comment->article_id}}"><b>{{ $articles[$comment->article_id]->pagetitle }}</b></a>
                </td>
                <td style="text-align:center;">
