<?php echo '<div class="row form-row">
    ...
    <div class="col">
        <div class="input-group mb-3">
            ...
            <input type="text" id="'.($id ?? '').'" class="form-control" name="builder['.($i ?? '9999').'][singleimg][src]" value="'.($value['src'] ?? '').'" placeholder="Image file" onchange="documentDirty=true;">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="builder['.($i ?? '9999').'][singleimg][alt]" value="'.($value['alt'] ?? '').'" placeholder="Image alt" onchange="documentDirty=true;">
        </div>
        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text">TIT</span>
            </div>
            <input type="text" class="form-control" name="builder['.($i ?? '9999').'][singleimg][title]" value="'.($value['title'] ?? '').'" placeholder="Image title" onchange="documentDirty=true;">
        </div>
