...
Новый интерфейс менеджера построен на **evo-ui** и **Livewire**. Вкладки, фильтры, пагинация, сортировка, таблица/список, модальные формы и редакторы обновляются без полной перезагрузки iframe.
