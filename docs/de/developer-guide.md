...
sArticles ist ein evo-ui + Livewire Modul. `ModulePanel` steuert die Tabs, evo-ui rendert Tabellen und Formulare, und `src/Tables/*TableData.php` liefert Daten und Business-Logik.
